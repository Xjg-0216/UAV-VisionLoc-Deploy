...
if __name__ == '__main__':
    ...
    # basic params
    parser.add_argument('--model_path', type=str, default= "/home/xujg/UAV-VisionLoc-Deploy/model/uvl_v0807.rknn", help='model path, could be .pt or .rknn file')

    parser.add_argument('--img_show', action='store_true', default=False, help='draw the result and show')
    parser.add_argument('--img_save', action='store_true', default=True, help='save the result')
    parser.add_argument('--save_path', default="/home/xujg/UAV-VisionLoc-Deploy/python/imgs", help='save the result')
    # data params
    parser.add_argument('--img_folder', type=str, default='/home/xujg/UAV-VisionLoc-Deploy/data/queries', help='img folder path')
    parser.add_argument('--path_local_database', type=str, default='/home/xujg/UAV-VisionLoc-Deploy/data/database/database_features.h5', help='load local features and utms of database')
