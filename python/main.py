...
def main():
    ...
    parser.add_argument('--use_cam', action='store_true', default=config["use_cam"], help='Use camera')
    ...
    if args.use_cam:
        logger.info("load video using camera.")
        process_video(pm, args)
        pass
    else:
        logger.info("load local queries path. ")
